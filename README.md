...
The primary conclusion is that the bottom deciles experienced a decline in income growth over this period, while the middle and top percentiles showed either negligible or positive growth. 
However, it is important to note that this analysis is still preliminary. Additionally, this analysis does not imply any causation from policies to distributional outcomes.
